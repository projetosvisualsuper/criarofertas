...
const CREDIT_PACKAGES: CreditPackage[] = [
    { id: 1, amount: 100, price: 19.90, name: 'Pacote Básico', description: 'Ideal para testes e uso leve.' },
    { id: 2, amount: 500, price: 79.90, name: 'Pacote Padrão', description: 'Melhor custo-benefício para uso regular.' },
    { id: 3, amount: 1500, price: 199.90, name: 'Pacote Premium', description: 'Para usuários avançados e alto volume.' },
];
...
const CreditPurchaseModal: React.FC<CreditPurchaseModalProps> = ({ trigger }) => {
  ...
  const [selectedPackage, setSelectedPackage] = useState<CreditPackage | null>(CREDIT_PACKAGES[0]);
