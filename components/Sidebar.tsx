          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2 p-3 bg-gray-50 rounded-lg border">
              ...
              <div className="grid grid-cols-2 gap-x-4 gap-y-2 pt-2">
                ...
                <div className="space-y-1"><div className="flex justify-between text-xs"><label className="font-medium text-gray-600">Posição X</label><span className="font-mono text-gray-500">{theme.footerText.x}px</span></div><input type="range" min="-100" max="100" value={theme.footerText.x} onChange={(e) => setTheme({...theme, footerText: {...theme.footerText, x: Number(e.target.value)}})} className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer"/></div>
                <div className="space-y-1"><div className="flex justify-between text-xs"><label className="font-medium text-gray-600">Posição Y</label><span className="font-mono text-gray-500">{theme.footerText.y}px</span></div><input type="range" min="-100" max="100" value={theme.footerText.y} onChange={(e) => setTheme({...theme, footerText: {...theme.footerText, y: Number(e.target.value)}})} className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer"/></div>
              </div>
            </div>
            <div className="space-y-2">
